#Prueba 3 conexion de todos los servomotores sin retrocesos
from time import *
...
def servo1():
	kit.servo[0].angle=90 #servo1 conectado en el canal 0 se posiciona a 0 grados 

def servo2():
	kit.servo[1].angle=90 #servo2 conectado en el canal 1 se posiciona a 90 grados 

def servo4():
	kit.servo[2].angle=90 #servo4 conectado en el canal 2 se posiciona a 0 grados 

def servo5():
	kit.servo[3].angle=90 #servo5 conectado en el canal 3 se posiciona a 0 grados 

def servo6():
	kit.servo[4].angle=90 #servo6 conectado en el canal 4 se posiciona a 0 grados 
